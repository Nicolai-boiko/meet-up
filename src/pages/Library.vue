            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center gap-1.5">
                ...
                <button
                  ...
                  class="shrink-0"
                  :class="
                    item.isFavorited ? 'text-amber-500' : 'text-gray-300 hover:text-amber-400'
                  "
                  title="В избранное"
                >
    ...
    <main class="flex-1 flex flex-col overflow-hidden">
      ...
      <div v-else-if="!isEditing && contentStore.current" class="flex-1 overflow-y-auto">
        <div class="max-w-3xl mx-auto px-8 py-6">
          ...
          <div class="flex items-start justify-between mb-6">
            <div>
              <div class="flex items-center gap-2 mb-1">
                <span class="text-2xl">
                  {{
                    contentStore.current.type === 'video'
                      ? '🎬'
                      : contentStore.current.type === 'link'
                        ? '🔗'
                        : contentStore.current.type === 'file'
                          ? '📁'
                          : '📄'
                  }}
                </span>
          ...
          <!-- Video embed -->
          <div
            v-if="contentStore.current.type === 'video' && contentStore.current.mediaUrl"
            class="mb-6"
          >
            ...
            <div class="space-y-2">
              ...
              >
                ...
                >
                  ...
                  <span v-if="f.fileSize" class="text-xs text-blue-400 shrink-0">{{
          ...
          <div
            v-else-if="
              contentStore.current.type === 'file' &&
              contentStore.current.mediaUrl &&
              !contentStore.current.files?.length
            "
            class="mb-6"
          >
            <a
...
const remainingCount = computed(() => Math.max(0, contentStore.total - contentStore.items.length))
